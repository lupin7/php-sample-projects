<?php
	...
	if( isset($_POST['search']) ) {
		$searched_title = '%' . $_POST['search'] . '%';
		if(strlen($searched_title) <= 0 || $searched_title == '') {
	...
	$select_all = "SELECT * FROM blogs WHERE content LIKE '{$searched_title}'";
...
<body>
    <div id="wrapper">
        ...
        <h3>Blog Archives found <?= $result->num_rows ?> Post:</h3>
        <ul id="posts">
